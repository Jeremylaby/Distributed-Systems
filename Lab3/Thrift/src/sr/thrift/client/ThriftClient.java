			...
			do {
				...
				try {
					if (line == null) {
						...
						List<CharInt> pairs = new ArrayList<>();

						pairs.add(new CharInt("S", 3));
						pairs.add(new CharInt("T", 2));
						pairs.add(new CharInt("A", 1));
						pairs.add(new CharInt("S", 3));
						pairs.add(new CharInt("Z", 5));
						pairs.add(new CharInt("E", 4));
						pairs.add(new CharInt("k", 2));
						String res = synCalc1.fun(pairs);
						System.out.println("fun(pairs) returned " + res);
					}else {
						System.out.println("???");
					}
				}
