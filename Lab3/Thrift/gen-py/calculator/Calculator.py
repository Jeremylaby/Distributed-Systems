...
class Processor(Iface, TProcessor):
    ...
    def process_fun(self, seqid, iprot, oprot):
        ...
        result = fun_result()
        try:
            result.success = self._handler.fun(args.pairs)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
fun_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'pairs', (TType.STRUCT, [CharInt, None], False), None, ),  # 1
)
