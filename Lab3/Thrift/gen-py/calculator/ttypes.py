...
class CharInt(object):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.char = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('CharInt')
        if self.char is not None:
            oprot.writeFieldBegin('char', TType.STRING, 1)
            oprot.writeString(self.char.encode('utf-8') if sys.version_info[0] == 2 else self.char)
            oprot.writeFieldEnd()
...
class InvalidArguments(TException):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(CharInt)
CharInt.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'char', 'UTF8', None, ),  # 1
